            ...
            <View className="w-full px-9">
                ...
                <View className="w-full items-left gap-3 mb-11">
                    ...
                    <Text className="font-regular text-sm text-gray-200">
                        Informação Tecnologia e Serviços
                    </Text>
                    ...
                    <View className="flex-row gap-5">
                        ...
                        <Text className="font-regular text-sm">
                            <Octicons name="people" size={16} color="gray" />{' '}
                            5000 + Funcionários
                        </Text>
                    </View>
                </View>
                ...
                <View className="w-full gap-4">
                    ...
                    <Text className="font-regular text-base">
                        ...
                        (HX). Somos especialistas na fabricação, desenvolvimento
                        e na implementação de softwares Omnichannel de Customer
                        Relationship Management (CRM) para todos os mercados.
                        Com mais de 30 anos de atuação, somos a primeira
                        companhia nacional do segmento a conquistar a
                        certificação internacional ISO 27001:2013, concedida a
                        organizações com elevado nível de qualidade e segurança
